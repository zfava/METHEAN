...
MATH_FOUNDATIONAL = Template(
    ...
    nodes=[
        TemplateNode("mf-01", "milestone", "Counting to 20", "Count objects to 20 with one-to-one correspondence. Recognize and write numerals 0-20.", 20, 0),
        TemplateNode("mf-02", "concept", "Number Recognition 0-100", "Identify and read numerals from 0 to 100. Understand place value conceptually.", 20, 1),
        TemplateNode("mf-03", "concept", "One-to-One Correspondence", "Match one object to one number when counting. Understand that the last number represents the total.", 15, 2),
        TemplateNode("mf-04", "skill", "Counting to 100", "Count to 100 by ones. Count by tens to 100. Count forward from any number.", 20, 3),
        TemplateNode("mf-05", "milestone", "Addition Facts to 10", "Learn all addition combinations that sum to 10 or less. Build toward automatic recall.", 30, 4),
        TemplateNode("mf-06", "milestone", "Subtraction Facts to 10", "Learn all subtraction facts within 10. Connect subtraction to addition as inverse operations.", 30, 5),
        TemplateNode("mf-07", "skill", "Addition Facts to 20", "Extend addition to sums within 20. Use strategies: counting on, making ten, doubles.", 25, 6),
        TemplateNode("mf-08", "skill", "Subtraction Facts to 20", "Extend subtraction within 20. Use addition knowledge to solve subtraction problems.", 25, 7),
        TemplateNode("mf-09", "concept", "Place Value Tens and Ones", "Understand that two-digit numbers are made of tens and ones. Decompose numbers like 34 = 3 tens + 4 ones.", 25, 8),
        TemplateNode("mf-10", "skill", "Skip Counting by 2s 5s 10s", "Count by 2s, 5s, and 10s to 100. Recognize skip counting patterns.", 20, 9),
        TemplateNode("mf-11", "concept", "Comparing Numbers", "Compare numbers using greater than, less than, and equal to. Use symbols > < =.", 20, 10),
        TemplateNode("mf-12", "concept", "Ordinal Numbers", "Understand position words: first through tenth. Apply ordinal numbers to sequences.", 15, 11),
        TemplateNode("mf-13", "skill", "Measurement Length", "Measure length using nonstandard units and rulers. Compare lengths of objects.", 20, 12),
        TemplateNode("mf-14", "skill", "Measurement Weight", "Compare weights of objects using balance scales. Use nonstandard units.", 20, 13),
        TemplateNode("mf-15", "skill", "Time Hours and Half Hours", "Read analog and digital clocks to the hour and half hour. Understand AM and PM.", 20, 14),
        TemplateNode("mf-16", "skill", "Coins Identification", "Identify penny, nickel, dime, quarter. Know their values.", 15, 15),
        TemplateNode("mf-17", "concept", "2D Shapes", "Identify and describe circles, squares, rectangles, triangles, hexagons. Count sides and vertices.", 20, 16),
        TemplateNode("mf-18", "concept", "Patterns and Sequences", "Identify, extend, and create repeating and growing patterns using objects, numbers, and shapes.", 20, 17),
        TemplateNode("mf-19", "skill", "Number Lines", "Use number lines to count, add, subtract, and compare numbers. Place numbers on a line.", 20, 18),
        TemplateNode("mf-20", "concept", "Even and Odd Numbers", "Identify even and odd numbers. Understand that even numbers can be split into two equal groups.", 15, 19),
        TemplateNode("mf-21", "concept", "Fractions Visual Half and Quarter", "Understand halves and quarters using pictures, objects, and folding. Equal parts of a whole.", 20, 20),
        TemplateNode("mf-22", "skill", "Tally Charts and Data", "Collect data, organize it in tally charts, and answer questions about the data.", 15, 21),
        TemplateNode("mf-23", "skill", "Word Problems Addition", "Solve single-step addition word problems. Identify key words and draw pictures to solve.", 25, 22),
        TemplateNode("mf-24", "skill", "Word Problems Subtraction", "Solve single-step subtraction word problems. Identify the operation needed.", 25, 23),
        TemplateNode("mf-25", "skill", "Addition of Three Numbers", "Add three single-digit numbers. Use strategies like making ten and doubles.", 20, 24),
        TemplateNode("mf-26", "skill", "Mental Math Strategies", "Develop mental math strategies: counting on, making ten, using doubles, breaking apart numbers.", 20, 25),
        TemplateNode("mf-27", "concept", "Estimation Introduction", "Estimate quantities and sums before calculating. Develop number sense for reasonableness.", 15, 26),
        TemplateNode("mf-28", "skill", "Number Bonds to 20", "Know all number bonds (pairs that make a given number) for numbers to 20.", 20, 27),
        TemplateNode("mf-29", "skill", "Sorting and Classifying", "Sort objects by color, shape, size, and other attributes. Classify into groups.", 15, 28),
        TemplateNode("mf-30", "milestone", "Foundational Math Assessment", "Comprehensive review and assessment of all foundational math skills.", 30, 29),
    ],
    edges=[
...
TEMPLATES: dict[str, Template] = {
    t.template_id: t
    for t in [
        MATH_FOUNDATIONAL, ELEMENTARY_CORE, CLASSICAL_LOGIC,
