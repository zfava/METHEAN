...
STATE_REQUIREMENTS: dict[str, dict] = {
    ...
    "AL": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school district superintendent",
            "when": "One-time upon beginning (church school option)",
        },
        "required_subjects": {},
        "instruction_hours": {},
    ...
    "AZ": {
        ...
        "notification": {
            "required": True,
            "to_whom": "County school superintendent",
            "when": "Within 30 days of starting (one-time affidavit)",
        },
    ...
    "AR": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school district superintendent",
            "when": "By August 15 (or December 15 for spring start)",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": None,
    ...
    "CA": {
        ...
        "notification": {
            "required": True,
            "to_whom": "County superintendent",
            "when": "Between October 1 and October 15 annually (PSA option)",
        },
        "required_subjects": {
    ...
    "CO": {
        ...
        "notification": {
            "required": True,
            "to_whom": "School district",
            "when": "14 days before starting, via certified mail",
        },
        "required_subjects": {
            "all": [
                "reading",
        ...
        "annual_assessment": {
            "required": True,
            "options": ["standardized test", "evaluation by qualified person", "evaluation by certified teacher"],
        },
        "record_retention_years": None,
    ...
    "DE": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Delaware Department of Education",
            "when": "One-time upon initially opening homeschool",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": None,
    ...
    "DC": {
        ...
        "notification": {
            "required": True,
            "to_whom": "DC Office of the State Superintendent of Education (OSSE)",
            "when": "15 business days before starting; continuation by August 15 annually",
        },
        "required_subjects": {
            "all": ["language arts", "mathematics", "science", "social studies", "art", "music", "health", "PE"]
        },
        "instruction_hours": {},
        "instruction_days": None,
        "attendance_tracking": False,
    ...
    "FL": {
        ...
        "notification": {
            "required": True,
            "to_whom": "County school superintendent",
            "when": "Within 30 days of starting",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": None,
    ...
    "GA": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Georgia Department of Education",
            "when": "By September 1 or within 30 days of starting",
        },
        ...
        "annual_assessment": {
            "required": True,
            "options": ["standardized test every 3 years (beginning at end of 3rd grade)"],
        },
    ...
    "HI": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Principal of child's zoned public school",
            "when": "Before beginning homeschool",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": None,
    ...
    "IN": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Indiana Department of Education",
            "when": "Enrollment report by first day of school year",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": 180,
    ...
    "KS": {
        ...
        "notification": {
            "required": True,
            "to_whom": "State Board of Education",
            "when": "One-time registration when starting",
        },
        "required_subjects": {},
        "instruction_hours": {},
    ...
    "KY": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local board of education",
            "when": "Within first two weeks of school year, annually",
        },
        "required_subjects": {
            "all": ["reading", "writing", "spelling", "grammar", "history", "mathematics", "science", "civics"]
        },
    ...
    "LA": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Board of Elementary and Secondary Education (BESE)",
            "when": "Within 15 days of starting; renewal by October 1 annually",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": 180,
    ...
    "ME": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school superintendent",
            "when": "Within 10 days of starting (one-time); annual letter by September 1",
        },
        "required_subjects": {
            "all": [
    ...
    "MD": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local superintendent",
            "when": "15 days before starting; annual verification to continue",
        },
    ...
    "MA": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school committee or superintendent",
            "when": "Annually; prior approval required before starting",
        },
        "required_subjects": {
            "all": [
                "reading",
    ...
    "MN": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school district superintendent",
            "when": "By October 1 annually, or within 15 days of withdrawal from public school",
        },
        "required_subjects": {
            "all": [
                "reading",
    ...
    "MS": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school attendance officer",
            "when": "By September 15 annually (Certificate of Enrollment)",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": None,
    ...
    "MT": {
        ...
        "notification": {
            "required": True,
            "to_whom": "County superintendent of schools",
            "when": "Annually at beginning of school fiscal year (July 1)",
        },
        "required_subjects": {
            "all": [
    ...
    "NC": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Division of Non-Public Education",
            "when": "One-time filing when starting (not annual)",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": None,
    ...
    "ND": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local public school district superintendent",
            "when": "At least 14 days before starting; annually via certified mail",
        },
    ...
    "NE": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Nebraska Department of Education",
            "when": "Annually by July 15",
        },
    ...
    "NV": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school district superintendent",
            "when": "Before starting; via certified mail (one-time unless name/address changes)",
        },
    ...
    "NH": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Participating agency (Commissioner of Ed, superintendent, or nonpublic school principal)",
            "when": "Within 5 days of commencing",
        },
        "required_subjects": {
            "all": [
                "science",
    ...
    "NM": {
        ...
        "notification": {
            "required": True,
            "to_whom": "New Mexico Public Education Department",
            "when": "Within 30 days of starting; annually by August 1",
        },
        "required_subjects": {"all": ["reading", "language arts", "mathematics", "social studies", "science"]},
        "instruction_hours": {},
        "instruction_days": 180,
    ...
    "NY": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school district superintendent",
            "when": "By July 1 or within 14 days of starting",
        },
        "ihip_required": True,
        "required_subjects": {
            "1-6": [
        ...
        "annual_assessment": {
            "required": True,
            "options": [
                "standardized test (above 33rd percentile or one year growth)",
                "written narrative by certified teacher",
            ],
        },
        "record_retention_years": None,
    ...
    "OH": {
        ...
        "notification": {
            "required": True,
            "to_whom": "School district superintendent",
            "when": "By August 30 or within 5 days of starting",
        },
        "required_subjects": {
            "all": ["English language arts", "mathematics", "science", "history", "government", "social studies"]
        },
        "instruction_hours": {},
        "instruction_days": None,
        "attendance_tracking": False,
        ...
        "annual_assessment": {
            "required": True,
            "options": ["standardized test", "written narrative", "portfolio review by certified teacher"],
        },
        "record_retention_years": None,
    ...
    "OR": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local Education Service District (ESD)",
            "when": "Within 10 days of starting (one-time filing)",
        },
        "required_subjects": {},
        "instruction_hours": {},
        "instruction_days": None,
    ...
    "SD": {
        ...
        "notification": {
            "required": True,
            "to_whom": "SD Department of Education or local school district",
            "when": "Within 30 days of beginning",
        },
    ...
    "UT": {
        ...
        "notification": {
            "required": True,
            "to_whom": "School district",
            "when": "At least 30 days before starting (one-time affidavit)",
        },
        "required_subjects": {
            "all": ["language arts", "mathematics", "science", "social studies", "arts", "health", "computing"]
        },
        "instruction_hours": {},
        "instruction_days": None,
        "attendance_tracking": False,
    ...
    "VA": {
        ...
        "annual_assessment": {
            "required": True,
            "options": [
                "standardized test (above 23rd percentile / 4th stanine)",
                "evaluation showing adequate progress",
            ],
        },
        "record_retention_years": None,
    ...
    "VT": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Vermont Secretary of Education / Agency of Education",
            "when": "At least 10 business days before starting; annually",
        },
        "required_subjects": {
    ...
    "WA": {
        ...
        "notification": {
            "required": True,
            "to_whom": "School district superintendent",
            "when": "By September 15 or within 2 weeks of starting",
        },
        "required_subjects": {
            "all": [
                "reading",
    ...
    "WV": {
        ...
        "notification": {
            "required": True,
            "to_whom": "County school board or superintendent",
            "when": "One-time Notice of Intent (Option 2, most popular)",
        },
    ...
    "WI": {
        ...
        "required_subjects": {
            "all": ["reading", "language arts", "mathematics", "social studies", "science", "health"]
        },
    ...
    "WY": {
        ...
        "notification": {
            "required": True,
            "to_whom": "Local school board",
            "when": "Annually with curriculum description",
        },
        "required_subjects": {
            "all": ["reading", "writing", "mathematics", "civics", "history", "literature", "science"]
        },
        "instruction_hours": {},
        "instruction_days": None,
        "attendance_tracking": False,
...
async def check_compliance(
    ...
    for subj in sorted(subjects_required):
        ...
        if matched:
            ...
            checks.append(
                {"requirement": f"{subj} instruction", "status": "not_met", "action": f"Add {subj} to curriculum"}
            )
