    ...
    "academic": [
        {
            ...
            "description": "Letter sounds through reading fluency",
            "category": "language",
        },
        {
            "id": "literature",
            "name": "Literature",
            "description": "Classic literature, great books, mythology",
            "category": "language",
        },
        {
            "id": "writing_grammar",
            "name": "Writing & Grammar",
            "description": "Composition, grammar, rhetoric",
            "category": "language",
        },
        {
            "id": "mathematics",
            "name": "Mathematics",
            "description": "Number sense through advanced mathematics",
            "category": "stem",
        },
        {
            "id": "science",
            "name": "Science",
            "description": "Natural sciences, experiments, scientific method",
            "category": "stem",
        },
        {
            "id": "history",
            "name": "History",
            "description": "Ancient through modern, primary sources",
            "category": "humanities",
        },
        {"id": "latin", "name": "Latin", "description": "Grammar, vocabulary, translation", "category": "language"},
        {
            "id": "logic",
            "name": "Logic",
            "description": "Formal logic, syllogisms, critical thinking",
            "category": "humanities",
        },
        {
            "id": "nature_study",
            "name": "Nature Study",
            "description": "Observation, journaling, ecology",
            "category": "stem",
        },
        {
            "id": "music_art",
            "name": "Music & Art",
            "description": "Music theory, instruments, visual arts",
            "category": "arts",
        },
        {
            "id": "geography",
        ...
        },
        {
            ...
            "description": "Modern language study",
            "category": "language",
        },
        {
            "id": "bible_theology",
            "name": "Bible & Theology",
            "description": "Scripture study, doctrine, church history",
            "category": "humanities",
        },
        {
            "id": "health_pe",
            "name": "Health & PE",
            "description": "Physical education, health, nutrition",
            "category": "life",
        },
        {
            "id": "computer_science",
            "name": "Computer Science",
            "description": "Programming, computational thinking",
            "category": "stem",
        },
        {
            "id": "rhetoric",
            "name": "Rhetoric & Composition",
            "description": "Persuasive writing, public speaking",
            "category": "language",
        },
        {
            "id": "government_economics",
            "name": "Government & Economics",
            "description": "Civics, political science, finance",
            "category": "humanities",
        },
    ],
    "vocational": [
        {
            "id": "woodworking",
            "name": "Woodworking",
            "description": "Hand tools, joinery, furniture construction",
            "category": "trades",
        },
        {
            "id": "electrical",
            "name": "Electrical Fundamentals",
            "description": "Circuits, wiring, NEC code basics",
            "category": "trades",
        },
        {
            "id": "welding",
            "name": "Welding",
            "description": "MIG, TIG, stick welding fundamentals",
            "category": "trades",
        },
        {
            "id": "automotive",
            "name": "Automotive",
            "description": "Engine systems, diagnostics, maintenance",
            "category": "trades",
        },
        {
            "id": "plumbing",
            "name": "Plumbing",
            "description": "Pipe fitting, fixtures, water systems",
            "category": "trades",
        },
        {"id": "hvac", "name": "HVAC", "description": "Heating, ventilation, air conditioning", "category": "trades"},
        {
            ...
            "description": "Culinary arts, meal planning, food safety",
            "category": "life",
        },
        {
            "id": "agriculture",
            "name": "Agriculture",
            "description": "Animal husbandry, crop management, soil science",
            "category": "life",
        },
        {
            "id": "sewing_textiles",
            "name": "Sewing & Textiles",
            "description": "Pattern reading, machine operation",
            "category": "life",
        },
        {
            "id": "small_engine",
            "name": "Small Engine Repair",
            "description": "Lawn equipment, generators, motors",
            "category": "trades",
        },
        {
            "id": "construction",
            "name": "Construction",
            "description": "Framing, roofing, drywall, finishing",
            "category": "trades",
        },
        {
            "id": "first_aid",
            "name": "First Aid / EMT",
            "description": "Emergency medicine, CPR, trauma response",
            "category": "life",
        },
        {
            "id": "entrepreneurship",
            "name": "Entrepreneurship",
            "description": "Business planning, accounting, marketing",
            "category": "life",
        },
    ],
}
