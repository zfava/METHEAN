...
def upgrade() -> None:
    ...
    op.execute(
        "CREATE INDEX IF NOT EXISTS ix_evalpred_child_node_created ON evaluator_predictions (child_id, node_id, created_at DESC)"
    )
    ...
    op.create_table(
        ...
        sa.Column("confidence_band_accuracy", postgresql.JSONB, nullable=False, server_default="{}"),
        sa.Column("subject_drift_map", postgresql.JSONB, nullable=False, server_default="{}"),
