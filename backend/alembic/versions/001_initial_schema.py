...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", PG_ENUM("owner", "co_parent", "observer", name="userrole", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("household_id", UUID(as_uuid=True), sa.ForeignKey("households.id", ondelete="CASCADE"), nullable=False),
        sa.Column("node_type", PG_ENUM("root", "milestone", "concept", "skill", name="nodetype", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("relation", PG_ENUM("prerequisite", "corequisite", "recommended", name="edgerelation", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("mastery_level", PG_ENUM("not_started", "emerging", "developing", "proficient", "mastered", name="masterylevel", create_type=False), nullable=False, server_default="not_started"),
    ...
    op.create_table(
        ...
        sa.Column("household_id", UUID(as_uuid=True), sa.ForeignKey("households.id", ondelete="CASCADE"), nullable=False),
        sa.Column("node_id", UUID(as_uuid=True), sa.ForeignKey("learning_nodes.id", ondelete="CASCADE"), nullable=False),
        sa.Column("event_type", PG_ENUM("mastery_change", "review_completed", "node_unlocked", "node_skipped", "override", name="stateeventtype", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("child_id", UUID(as_uuid=True), sa.ForeignKey("children.id", ondelete="CASCADE"), nullable=False),
        sa.Column("household_id", UUID(as_uuid=True), sa.ForeignKey("households.id", ondelete="CASCADE"), nullable=False),
        sa.Column("rating", PG_ENUM("1", "2", "3", "4", name="fsrsrating", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("household_id", UUID(as_uuid=True), sa.ForeignKey("households.id", ondelete="CASCADE"), nullable=False),
        sa.Column("created_by", UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="SET NULL")),
        sa.Column("rule_type", PG_ENUM("pace_limit", "content_filter", "schedule_constraint", "ai_boundary", "approval_required", name="ruletype", create_type=False), nullable=False),
        sa.Column("scope", PG_ENUM("household", "child", "subject", "map", name="rulescope", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("action", PG_ENUM("approve", "reject", "modify", "defer", name="governanceaction", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("description", sa.Text),
        sa.Column("status", PG_ENUM("draft", "proposed", "approved", "active", "completed", "archived", name="planstatus", create_type=False), nullable=False, server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("activity_type", PG_ENUM("lesson", "practice", "assessment", "review", "project", "field_trip", name="activitytype", create_type=False), nullable=False),
        sa.Column("title", sa.String(255), nullable=False),
        sa.Column("description", sa.Text),
        sa.Column("instructions", JSONB, server_default="{}"),
        sa.Column("estimated_minutes", sa.Integer),
        sa.Column("status", PG_ENUM("scheduled", "in_progress", "completed", "skipped", "cancelled", name="activitystatus", create_type=False), nullable=False, server_default="scheduled"),
    ...
    op.create_table(
        ...
        sa.Column("household_id", UUID(as_uuid=True), sa.ForeignKey("households.id", ondelete="CASCADE"), nullable=False),
        sa.Column("child_id", UUID(as_uuid=True), sa.ForeignKey("children.id", ondelete="CASCADE"), nullable=False),
        sa.Column("status", PG_ENUM("started", "completed", "abandoned", name="attemptstatus", create_type=False), nullable=False, server_default="started"),
    ...
    op.create_table(
        ...
        sa.Column("artifact_type", PG_ENUM("photo", "video", "document", "audio", "link", name="artifacttype", create_type=False), nullable=False),
        sa.Column("title", sa.String(255), nullable=False),
        sa.Column("description", sa.Text),
    ...
    op.create_table(
        ...
        sa.Column("severity", PG_ENUM("info", "warning", "action_required", name="alertseverity", create_type=False), nullable=False),
        sa.Column("status", PG_ENUM("unread", "read", "dismissed", "acted_on", name="alertstatus", create_type=False), nullable=False, server_default="unread"),
        sa.Column("title", sa.String(255), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", PG_ENUM("pending", "running", "completed", "failed", name="airunstatus", create_type=False), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("user_id", UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="SET NULL")),
        sa.Column("action", PG_ENUM("create", "read", "update", "delete", "login", "logout", "export", name="auditaction", create_type=False), nullable=False),
